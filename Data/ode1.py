...
for i in range(num_curves):
    ...
    sample = amplitudes[i] * np.sin(4 * pi * x_values)
...
np.savez_compressed('Exp1_Train.npz', X=x_values, voltage=samples_train, displacement=disp_train)
np.savez_compressed('Exp1_Test.npz', X=x_values, voltage=samples_test, displacement=disp_test)
