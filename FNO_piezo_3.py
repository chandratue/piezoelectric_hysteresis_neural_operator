...
modes = 16    #16                   # number of Fourier modes to multiply, at most floor(N/2) + 1
width = 64    #64                   # number of hidden channel
...
plt.tight_layout()
plt.savefig("Results/FNO/FNO_Exp3.png", dpi=300)
plt.show()
